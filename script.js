document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function showError(field, message) {
      ...
      errorEl.style.cssText = 'color:#e53e3e;font-size:0.8rem;display:block;margin-top:4px;';
  ...
  if (animatedElements.length > 0) {
    animatedElements.forEach(function (el) {
      ...
      const animation = el.dataset.animate || el.className.match(/fade-in(-\w+)?/)?.[0] || 'fade-in';

      if (animation.includes('up') || animation === 'fade-in') {
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Nova Life uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '54efa16c-9e8b-4cf6-b3be-4928b2ad9ee3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '54efa16c-9e8b-4cf6-b3be-4928b2ad9ee3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '54efa16c-9e8b-4cf6-b3be-4928b2ad9ee3';
